...
var checkURLFile = function(urlcontent, checksfile) {
...
var buildfn = function(csvfile, headers) {
	...
	//	console.log(result);
            checkURLFile(result, headers);
        }
    };
    return response2console;
};

var chkHtmlURL = function(URLfile, headers) {
   
    var response2console = buildfn(URLfile, headers);
...
var x = chkHtmlURL(program.url,program.checks);
